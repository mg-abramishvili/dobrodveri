...
export default {
    ...
    methods: {
        loadSurface() {
            axios.get(`/_admin/surface/${this.$route.params.id}`)
            .then(response => {
        ...
        save() {
            ...
            if(this.$route.params.id) {
                axios.put(`/_admin/surface/${this.$route.params.id}/update`, postData)
                .then(response => {
                    this.views.saveButton = true
                    this.$router.push({ name: 'Surfaces' })
                })
                .catch(errors => {
                    this.views.saveButton = true
            ...
            if(!this.$route.params.id) {
                axios.post(`/_admin/surfaces`, postData)
                .then(response => {
                    this.views.saveButton = true
                    this.$router.push({ name: 'Surfaces' })
                })
