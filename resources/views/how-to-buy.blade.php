    ...
    <div class="container pt-1 pb-1">
        ...
        <ul class="how-to-buy-list">
            <li class="how-to-buy-item">
                <div class="how-to-buy-item-icon">
            ...
            <li class="how-to-buy-item">
                <div class="how-to-buy-item-icon">
                    ...
                    <div class="how-to-buy-item-icon-count">2</div>
                </div>
                <div class="how-to-buy-item-title">
                    Выезд нашего специалиста
                </div>
                <div class="how-to-buy-item-text">
                    Сделаем все необходимые замеры. Консультируем и помогаем в выборе двери. Рассчитываем стоимость под ключ. Заключаем договор.
                </div>
            </li>
            ...
            <li class="how-to-buy-item">
                <div class="how-to-buy-item-icon">
                    ...
                    <div class="how-to-buy-item-icon-count">3</div>
                </div>
                <div class="how-to-buy-item-title">
                    Доставка и установка двери
                </div>
                <div class="how-to-buy-item-text">
                    Аккуратно доставим ваши двери в короткие сроки и качественно установим.
                </div>
            </li>
            ...
            <li class="how-to-buy-item">
                <div class="how-to-buy-item-icon">
                    ...
                    <div class="how-to-buy-item-icon-count">4</div>
                </div>
                <div class="how-to-buy-item-title">
                    Готово
                </div>
                <div class="how-to-buy-item-text">
                    Примите работу. Понравилось? Расскажите об этом!
                </div>
            </li>
        </ul>
    </div>
