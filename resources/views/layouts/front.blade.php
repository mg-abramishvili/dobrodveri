    ...
    <body>
        <div id="front" class="wrapper">
                ...
                <div class="header-top">
                    <div class="container">
                        ...
                        <div class="header-top-tel">
                            <a href="tel:+79273354040">8 (927) 335-40-40</a>
                ...
                <div class="footer-top">
                    <div class="container">
                        <div class="footer-about">
                            ...
                            <p>© 2022-{{ now()->year }} «Добродвери».<br>Все права защищены.</p>
            ...
            <div class="quiz-banner">
                <div class="container">
                    <p>Ответьте на 6 простых вопросов и получите расчет стоимости дверей с установкой под ключ</p>
        ...
        <script>
            function toggleSearchForm() {
                ...
                if(searchForm.style.display == 'block') {
                    ...
                    setTimeout(() => {
                        document.querySelector('.search-form form input').focus()
                    }, 100)
                }
            }
        </script>
